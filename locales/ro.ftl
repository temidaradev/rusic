...
ytdlp_embed_metadata = Încorporatează metadate
ytdlp_embed_thumbnail = Încorporatează miniatură
ytdlp_embed_chapters = Încorporatează capitole
ytdlp_embed_subtitles = Încorporatează subtitrări
ytdlp_embed_info_json = Încorporatează JSON cu informații
